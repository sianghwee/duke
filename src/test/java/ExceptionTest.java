...
public class ExceptionTest {
    ...
    public void testInvalidCommand(){
        assertEquals("OOPS!!! I'm sorry, but I don't know what that means.",
                new InvalidCommand().toString());
    }

    @Test
    public void testInvalidDescription(){
        assertEquals("OOPS!!! The description of a test cannot be empty.",
                new InvalidDescription("test").toString());
    }

    @Test
    public void testMissingPreposition(){
        assertEquals("Oops!! test requires a preposition for the time.",
                new MissingPreposition("test").toString());
    }
}
